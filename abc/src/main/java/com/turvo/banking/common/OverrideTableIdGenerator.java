 ...
 * @author anushm
 */
public class OverrideTableIdGenerator extends TableGenerator {

    public static final String ENTITY_NAME_PARAM = "entity_name";
    private static final Map<String, Field> FIELD_CACHE = Collections.synchronizedMap(new HashMap<String, Field>());
